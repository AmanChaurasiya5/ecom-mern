    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          <select onChange={(e) => setCategory(e.target.value)} className='w-full px-3 py-3'>
        ...
        <div>
          ...
          <select onChange={(e) => setSubCategory(e.target.value)} className='w-full px-3 py-3'>
      ...
      <button type='submit' className='w-28 py-3 bg-black text-white mt-4'>
        ADD
      </button>
    </form>
  )
